<template>
    <div class="login-container">
      <el-form  ref="loginForm" :model="emailLoginForm"  class="login-form" auto-complete="on" label-position="left">
        ...
        <div class="tips">
          ...
          <span style="margin-right:122px;"> password: any</span>
          <slot></slot>
        </div>
      ...
      handleLogin() {
        ...
        this.$refs.loginForm.validate(valid => {
          ...
          if (valid) {
            console.log('2')
            this.loading = true
            this.$store.dispatch('user/login', this.emailLoginForm).then(() => {
